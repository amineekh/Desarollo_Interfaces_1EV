        ...
        añadir_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!nombre_Field.getText().isEmpty() && !apellido_Field.getText().isEmpty() && !email_Field.getText().isEmpty() && !pass_Field.getText().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(UserApplication_Orden.this, "Por favor, rellene los campos obligatorios.");
                }
            }
        });
        ...
        modificar_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1 && !nombre_Field.getText().isEmpty() && !apellido_Field.getText().isEmpty() && !email_Field.getText().isEmpty() && !pass_Field.getText().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(UserApplication_Orden.this, "Por favor, seleccione una fila y rellene los campos obligatorios.");
                }
            }
        });
        ...
        borrar_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    int confirm = JOptionPane.showConfirmDialog(UserApplication_Orden.this, "¿Está seguro de que desea eliminar este usuario?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
                    ...
                    JOptionPane.showMessageDialog(UserApplication_Orden.this, "Por favor, seleccione una fila para eliminar.");
                }
            }
        });
